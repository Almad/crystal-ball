...
ROOT_URLCONF = 'crystal_ball.urls'
...
DEBUG_TOOLBAR_CONFIG = {
    ...
    'SHOW_TOOLBAR_CALLBACK': 'crystal_ball.settings.base.custom_show_toolbar',
...
WSGI_APPLICATION = 'crystal_ball.wsgi.application'
...
SYSTEM_EMAIL_PREFIX = "[crystal_ball]"

## Log settings

LOG_LEVEL = logging.INFO
HAS_SYSLOG = True
SYSLOG_TAG = "http_app_crystal_ball"  # Make this unique to your project.
