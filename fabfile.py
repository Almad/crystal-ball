"""
Starter fabfile for deploying the crystal_ball project.
...
# CHANGEME
env.hosts = ['user@crystal_ball.example.com']
env.code_dir = '/srv/www/crystal_ball'
env.project_dir = '/srv/www/crystal_ball/crystal_ball'
env.static_root = '/srv/www/crystal_ball/static/'
env.virtualenv = '/srv/www/crystal_ball/.virtualenv'
env.code_repo = 'git@github.com:user/crystal_ball.git'
env.django_settings_module = 'crystal_ball.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/crystal_ball/wsgi.py" % env.code_dir)
